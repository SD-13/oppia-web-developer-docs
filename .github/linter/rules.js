...
module.exports = [{
    // names: ["Note notation"],
    // description: "Check Note notation to make it noticable",
    // tags: [],
    ...
    description: "Notes should be preceded by '> **Note**'",
    tags: ["notes", "markdown"],
    function: (params, onError) => {
            ...
            if(line.match(/^\*\*Note\*\*/)){
                if(!params.lines[lineNumber-1].match(/^> \*\*Note\*\*$/)){
                    onError({
                        ...
                        detail: "The phrase '**Note**' should be preceded by '> **Note**'",
                        context: line
                    });
                }
            }
    ...
    description: "Warning should be preceded by '> **Warning**'",
        ...
        params.lines.forEach(function forLine(line, lineNumber) {
            if(line.match(/^\*\*Warning\*\*/)){
                if(!params.lines[lineNumber-1].match(/^> \*\*Warning\*\*$/)){
                    onError({
                        lineNumber: lineNumber+1,
                        detail: "The phrase '**Warning**' should be preceded by '> **Warning**'",
                        context: line
                    });
                }
            }
